      ...
      >
        <div className="container py-6 px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <h3 className="text-sm font-bold text-[#1F1F1F] mb-2">Kata Admin</h3>
            ...
            >
              ...
              <p className="text-xs text-[#9E9E9E]">© {currentYear} Kata. All rights reserved.</p>
            </motion.div>
          </div>
      ...
      <div className="container py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                <h3 className="text-lg font-bold">Kata</h3>
        ...
        <div className="border-t border-white/20 pt-6 mt-8">
          <div className="flex flex-col md:flex-row items-center justify-between text-sm opacity-80">
            <p className="mb-3 md:mb-0">© {currentYear} Kata. All rights reserved.</p>
